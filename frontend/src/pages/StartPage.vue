  ...
  <q-page>
    <div>
      <q-card flat class="bg-grey-2 q-mt-lg q-ma-md">
        <q-card-section>
          <div v-if="meals_confirmed" class="text-h6 text-weight-bold text-center">Heute wurde bereits das Essen bestellt für </div>
        ...
        <q-card-section v-if="meals_confirmed">
          ...
          <div class="column q-pa-sm items-center">
            <q-btn class="btn-fixed-width" color="info" text-color="white" label="Korrigieren" @click="meals_confirmed=false"/>
          </div>
        </q-card-section>
        <q-card-section v-else>
          <div class="column q-pa-sm items-center">
            <div class="q-gutter-md">
              <q-btn v-if="count > 0" class="btn-small-fixed-width text-h6" color="negative" text-color="white" label="-" @click="count--"/>
              <q-btn v-if="count == 0" class="btn-small-fixed-width text-h6" disabled color="negative" text-color="white" label="-"/>
              <q-btn class="btn-small-fixed-width text-h6" color="negative" text-color="white" label="+" @click="count++"/>          
            </div>
          </div>
          <div class="column q-pa-sm items-center">
            <q-btn class="btn-fixed-width" color="positive" text-color="white" label="Bestätigen" @click="confirm=true"/>
          </div>
        </q-card-section>
      </q-card>
